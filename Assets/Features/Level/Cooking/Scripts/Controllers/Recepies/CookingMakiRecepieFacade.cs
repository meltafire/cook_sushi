...
{
    public class CookingMakiRecepieFacade : MvcFacade<CookingMakiRecepieController, IngridientButtonView>
    {
        ...
        public CookingMakiRecepieFacade(AssetInstantiator<IngridientButtonView> assetInstantiator, Container container) : base(assetInstantiator, container)
        {
        }
    }
}